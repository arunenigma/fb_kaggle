...
class NeuroFuzzySystemTRAIN(object):
    def __init__(self):
        self.word_list = []
        self.cog_list = []
        self.word_info = {}
    ...
    def neuroFuzzyModellingTRAIN(self, tf_idf_list, u1, u2, u3, u4, u5, u6, u13, u14,
                                 tf_idf_bigram_list,
    ...
    def normCOGUnigrams(self):
        ...
        if not len(self.cog_list) < 1:
            ...
            for item in sorted_word_rank:
                ...
                self.PI_bundle_unigrams[item[0]] = self.uni_gram_lv_list
    ...
    def normCOGBigrams(self):
        if not len(self.cog_list_bigrams) < 1:
            ...
            for item in sorted_word_rank:
                ...
                self.PI_bundle_bigrams[item[0]] = self.bi_gram_lv_list
    ...
    def normCOGTrigrams(self):
        if not len(self.cog_list_trigrams) < 1:
            ...
            for item in sorted_word_rank:
                ...
                self.PI_bundle_trigrams[item[0]] = self.tri_gram_lv_list